...
app.get('/signup', (req, res) => {
  ...
  app.post('/signup', async (req, res) => {
    ...
    const msg = {
      ...
      from: 'Clients@SticksandStonesLaw.com', // Change to your verified sender
  ...
  app.get('/confirm', async (req, res) => {
    try {
      ...
      if (contact.custom_fields.conf_num ==  req.query.conf_num) {
        const listID = await getListID('SticksStones');
...
const signUpPage = {
    title: 'YOU NEED A LAWYER?',
    subtitle: 'SIGN UP TODAY, SO WE CAN HELP YOU WITH THAT.',
    form: `<form action="/signup" id="contact-form" method="post" style="margin: 10%;  width: 80%;">
        ...
        <button type="submit" style="background:#f4c9d6 !important;" class="btn btn-primary">SUBSCRIBE</button>
    </form>`
   };
